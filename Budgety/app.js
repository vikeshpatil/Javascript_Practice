...
var budgetController = (function(){
    ...
    return {
        ...
        deleteItem: function(type, id){
            ...
            if(index !== -1){
                data.allItems[type].splice(index, 1); // splice(index, number of items from that index); deletes items
            }
        },
...
var uiController = (function(){
    ...
    return {
        ...
        dispayPercentage: function(percentages){
...
var controller = (function(budgetctrl, uictrl){
    ...
    var updatePercentages = function(){
        ...
        uictrl.dispayPercentage(percentages);
